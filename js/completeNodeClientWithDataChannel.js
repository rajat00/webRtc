...
//navigator.getUserMedia  This feature is no longer recommended.
...
var socket = io.connect("https://myastrology-socket-api.singsys.net/webRTC");
...
//   navigator.getUserMedia(constraints, handleUserMedia, handleUserMediaError);
  navigator.mediaDevices
    ...
    .then((stream) => handleUserMedia(stream))
...
//   navigator.getUserMedia(constraints, handleUserMedia, handleUserMediaError);
  navigator.mediaDevices
    .getUserMedia(constraints)
    .then((stream) => handleUserMedia(stream))
    .catch((err) => {console.log('here is error');handleUserMediaError(err)});
  console.log("Getting user media with constraints", constraints);
});
...
socket.on("message", function (message) {
  ...
  if (message === "got user media") {
    ...
    console.log('message typ is "offer"');
    ...
    console.log('message typ is "answer"');
    pc.setRemoteDescription(new RTCSessionDescription(message));
...
function checkAndStart() {
    ...
    console.log('isChannelReady is ', isChannelReady);
  if (!isStarted && typeof localStream != "undefined" && isChannelReady) {
    console.log('Inside checkAndStart() if condition');
